...
// https://docs.soliditylang.org/en/v0.8.19/contracts.html#inheritance
...
contract Inheritance4 is Token2 {
    constructor(uint _totalSupply) Token2(_totalSupply) {
      // Forwards the constructor arguments to the parent constructor
    }

    // Overrides the balanceOf function in the parent contract
