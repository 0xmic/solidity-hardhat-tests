...
contract Mappings1 {
    mapping(uint => string) public colors; // Mapping of string like a databse
    ...
    constructor() {
        ...
        addresses[1] = 0xb47e3cd837dDF8e4c57F05d70Ab865de6e193BBB;
        addresses[2] = 0xBC4CA0EdA7647A8aB7C2061c2E118A18a936f13D;

        balances[0xb47e3cd837dDF8e4c57F05d70Ab865de6e193BBB] = 1 ether;
        balances[0xBC4CA0EdA7647A8aB7C2061c2E118A18a936f13D] = 2 ether;

        hasVoted[0xb47e3cd837dDF8e4c57F05d70Ab865de6e193BBB] = true;
        hasVoted[0xBC4CA0EdA7647A8aB7C2061c2E118A18a936f13D] = true;
    }
...
contract Mappings2 {
    ...
    constructor() {
        ...
        address user1 = 0xb47e3cd837dDF8e4c57F05d70Ab865de6e193BBB;
        address user2 = 0xBC4CA0EdA7647A8aB7C2061c2E118A18a936f13D;
