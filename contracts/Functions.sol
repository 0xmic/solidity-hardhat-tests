...
// Visibility
// https://docs.soliditylang.org/en/v0.8.19/contracts.html#function-visibility
...
contract Functions7 {
    ...
    function getName4() public pure returns(string memory anotherName) {
        anotherName = "Another name";
    }

    function getName5() public pure returns(string memory anotherName) {
