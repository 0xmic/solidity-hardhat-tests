...
describe('Variables', () => {
  ...
  describe('Example 6', () => {
    ...
    it('proves that "name1" is an internal variable and not directly accessible', async () => {
      // By default, this test should fail as the internal variable is not directly accessible
      // TODO: uncomment this out to see failure
      // await expect(contract.name1()).to.be.reverted
    })

    it('proves that "name2" is a private variable and not directly accessible', async () => {
      // By default, this test should fail as the private variable is not directly accessible
      // TODO: uncomment this out to see failure
      // await expect(contract.name2()).to.be.reverted
    })

    it('proves that "name3" is an internal variable and not directly accessible', async () => {
      // By default, this test should fail as the internal variable is not directly accessible
      // TODO: uncomment this out to see failure
      // await expect(contract.name3()).to.be.reverted
    })

    it('proves that "name4" is a public variable and is directly accessible', async () => {
